...
Create a list of SNPs in VCF and assign line numbers that can be used to find matching line numbers in outliers (SNP IDs are lost in BayeScan, line numbers are used as signifiers).
